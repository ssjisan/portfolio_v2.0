...
import { Behances, Dribbbles, Uplabs } from "../../assets/Icons";
    ...
    return (
        <Container sx={{ pt: "80px", pb: "80px" }}>
            <Box sx={{ mb: "64px", width: "100%", display: "flex", justifyContent: "center" }}>
                <Typography variant="h2" sx={{ width: "100%", maxWidth: "640px", textAlign: "center" }} color={light ? "text.tertiary" : "text.primary"}>Visit dribbble, uplabs, behance for more project updates.</Typography>
            </Box>
            <Grid container spacing={3} sx={{ justifyContent: "center" }}>
                ...
                <Grid item xs={12} sm={6} md={4} lg={4}>
                    <a href="https://www.uplabs.com/ssjisan" target="_blank">
                        <Box sx={BoxSx}>
                            <Uplabs />
                        </Box>
                    </a>
