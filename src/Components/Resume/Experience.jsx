...
export default function Experience() {
    ...
    const BulletPointSx = { display: "flex", alignItems: "flex-start", gap: "8px", mb: "16px" }
    return (
        <Box>
            <Typography sx={{ mb: "40px" }} variant="h3" color={light ? "text.tertiary" : "text.primary"}>Experience</Typography>
